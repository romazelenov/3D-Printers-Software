...
// LCD Menu Messages
  ...
  #define MSG_DELTA_CALIBRATION     "Calibration"
  #define MSG_UNLOAD_FILAMENT "Unload filament"
  #define MSG_LOAD_FILAMENT "Load filament"
  #define MSG_DELTA_CALIBRATE_X "Calibr A (X)"
  #define MSG_DELTA_CALIBRATE_Y "Calibr B (Y)"
  #define MSG_DELTA_CALIBRATE_Z "Calibr C (Z)"
  #define MSG_DELTA_CALIBRATE_CENTER "Calibr Center"
  #define MSG_MOVE_Z0 "Move to Z0"
  #define MSG_DELTA_DIAGONAL        "Diagonal   "
  #define MSG_DELTA_RADIUS          "DeltaRadius"
  #define MSG_AUTOCALIBRATION       "Autocalibration  "
  #define MSG_Z_HEIGHT              "Z-height  "
...
#define DISPLAY_CHARSET_ISO10646_5
	...
	#define MSG_SD_INSERTED						"Флешка вставлена"
	#define MSG_SD_REMOVED						"Флешка извлечена"
	#define MSG_MAIN							    "Меню"   
	#define MSG_AUTOSTART						  "Автостарт"
	#define MSG_DISABLE_STEPPERS	    "Выключить моторы"
	#define MSG_AUTO_HOME						  "Домой (autohome)"
	...
	#define MSG_COOLDOWN						  "Выкл нагрев"
	#define MSG_SWITCH_PS_ON					"Switch Power On   "
	#define MSG_SWITCH_PS_OFF					"Switch Power Off  "
	...
	#define MSG_NOZZLE							  "t\001 Сопло"
	#define MSG_NOZZLE1							  "\002 Фильера2:"
	#define MSG_NOZZLE2							  "\002 Фильера3:"
	#define MSG_BED								    "t\001 Кровать"
	#define MSG_FAN_SPEED						  "Обдуф ффу-у-у"
	#define MSG_FLOW							    "Подача"
	...
	#define MSG_A_RETRACT						  "A-retract"
	#define MSG_XSTEPS							  "X шагов/мм"
	#define MSG_YSTEPS							  "Y шагов/mm"
	#define MSG_ZSTEPS							  "Z шагов/mm"
	#define MSG_ESTEPS							  "E шагов/mm"
	#define MSG_RECTRACT    					"Откат подачи"
	#define MSG_TEMPERATURE  				  "Температура"
	#define MSG_MOTION						    "Механика"  //\x7E"
	#define MSG_CONTRAST              "LCD контраст"
	#define MSG_STORE_EPROM						"Сохранить настройк"
	#define MSG_LOAD_EPROM						"Загрузить настройк"  
	#define MSG_RESTORE_FAILSAFE	    "Сброс настроек"
	#define MSG_REFRESH							  "\004Обновить"
	#define MSG_WATCH							    "Инфо"
	#define MSG_PREPARE							  "Перед печатью"
	#define MSG_TUNE					        "Настройки на ходу"
	#define MSG_PAUSE_PRINT					  "Пауза печати"
	#define MSG_RESUME_PRINT				  "Продолжить печать"
	#define MSG_STOP_PRINT					  "Остановить печать"
	#define MSG_CARD_MENU						  "Файлы на флешке"
	#define MSG_NO_CARD							  "Нет флешки "
	...
	#define MSG_KILLED							  "Внутренняя ошибка()" // killed()
	...
	#define MSG_INIT_SDCARD           "Init. SD-Card"	
	#define MSG_CNG_SDCARD            "Change SD-Card"
  #define MSG_DELTA_CALIBRATION     "Калибровка дельты"
  #define MSG_UNLOAD_FILAMENT       "Запхнуть пруток"
  #define MSG_LOAD_FILAMENT         "Вытащить пруток"
  #define MSG_DELTA_CALIBRATE_X     "Идти к A (X)"
  #define MSG_DELTA_CALIBRATE_Y     "Идти к B (Y)"
  #define MSG_DELTA_CALIBRATE_Z     "Идти к C (Z)"
  #define MSG_DELTA_CALIBRATE_CENTER "Идти в центр"
  #define MSG_MOVE_Z0               "Опустить в Z0"
  #define MSG_DELTA_DIAGONAL        "Диагональ"
  #define MSG_DELTA_RADIUS          "Д-Радиус"
  #define MSG_AUTOCALIBRATION       "Автокалибровка"
  #define MSG_Z_HEIGHT              "Z высота"
...
/*
	...
	#define MSG_HEATING							    "Греем сопло  "
	#define MSG_HEATING_COMPLETE				"Нагрето.           "
	#define MSG_BED_HEATING						  "Греем стол...      "
