...
#define STRING_CONFIG_H_AUTHOR "3DQuality firmware V2.0rus" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "Prism Mini "
...
// Our COS and SIN values
#define SIN_A 0.835807361
#define COS_A 0.549022817
#define SIN_B 0.884743720
#define COS_B 0.466077834

// Z-Probe variables
// Start and end location values are used to deploy/retract the probe (will move from start to end and back again) 
#define Z_PROBE_OFFSET {0, 0, 3.73, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.
#define Z_PROBE_DEPLOY_START_LOCATION {20, 0, 30, 0}   // X, Y, Z, E start location for z-probe deployment sequence
#define Z_PROBE_DEPLOY_END_LOCATION {5, 50, 30, 0} 	  // X, Y, Z, E end location for z-probe deployment sequence
#define Z_PROBE_RETRACT_START_LOCATION {49, 50, 20, 0}  // X, Y, Z, E start location for z-probe retract sequence
#define Z_PROBE_RETRACT_END_LOCATION {49, 50, 20, 0}     // X, Y, Z, E end location for z-probe retract sequence 
...
// 111 is for 108 & 117 delta prism pro termistor
...
// so you shouldn't use it unless you are OK with PWM on your bed.  (see the comment on enabling PIDTEMPBED)
 ...
 #else
   #define MAX_BED_POWER 257 // 256=on
 #endif
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    ...
    #define  DEFAULT_bedKp 66.87
    #define  DEFAULT_bedKi 11.60
    #define  DEFAULT_bedKd 96.41
//120v 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
//from pidautotune
...
#define X_ENABLE_ON 0 // 1 for CCDRIVER LM8729
#define Y_ENABLE_ON 0 // 1
#define Z_ENABLE_ON 0 // 1
#define E_ENABLE_ON 0 //1 // For all extruders
...
#define MANUAL_Z_HOME_POS 217.96  // For delta: Distance between nozzle and print surface after homing.
...
// default settings
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100, 100, 100, 156.0}
...
//If you want boot sound uncomment this:
#define BOOT_SOUND
...
#define LANGUAGE_CHOICE 1 //  currently 1 and 6 work good

#define AUTOSAVE_G30A // G30A calls M500 when done


// Add parking option to G28 ( after 100% SDCARD printing)
//#define PARKING_GCODE_1 "G4 S10"
//#define PARKING_GCODE_2 "G1 X10 Y10 Z150 F3000"
//#define PARKING_GCODE_3 "G1 Z145"
