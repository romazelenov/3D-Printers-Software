...
enquecommand("M300 S1700 P80");
enquecommand("M300 S1900 P80 ");
enquecommand("M300 S2100 P80 ");
enquecommand("M300 S2300 P80 ");
...
static void lcd_implementation_drawmenu_setting_edit_generic(uint8_t row, const char* pstr, char pre_char, char* data)
{
    ...
    n=n - lcd_strlen_P(pstr)- strlen(data);
    lcd.print(':');
    while(n--)   lcd.print(' ');
    lcd.print(data);
}
